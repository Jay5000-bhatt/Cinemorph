...
const RatingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://cinemorph-api-git-master-jay-bhatts-projects.vercel.app/api/ratings", {
        contentId,
        userId: userName,
        rating,
        comment,
  ...
  const fetchComments = async () => {
    try {
      ...
      const response = await axios.get(
        `https://cinemorph-api-git-master-jay-bhatts-projects.vercel.app/api/ratings/posts/${tmdbId}/comments`
      );
